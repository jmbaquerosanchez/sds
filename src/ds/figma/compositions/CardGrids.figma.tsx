...
import { CardGrid } from "compositions";
import { Flex, FlexItem, Section } from "layout";
//import type { ReactNode } from "react";

/*
type PricingCardGridExampleProps = {
  schedule: ReactNode;
};

export function PricingCardGridExample({
  schedule,
}: PricingCardGridExampleProps) {
...
figma.connect(Section, "<FIGMA_SECTIONS_CARD_GRID_PRICING>", {
  ...
  example: ({ schedule }) => (
    <PricingCardGridExample schedule={schedule} />
  ),
});
*/
figma.connect(CardGrid, "<FIGMA_SECTIONS_CARD_GRID_PRICING>", {
  props: {
    children: figma.children(["Navigation Pill List", "Pricing Card"]),
  },
