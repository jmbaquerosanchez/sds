...
type HeaderAuthProps = Pick<AuthContextType, "user" | "login" | "logout">;

export function HeaderAuth({ user, login, logout }: HeaderAuthProps) {
  ...
  const navItems = ["About", "Contact us", "Pricing", "Waitlist", "Products"];
      ...
      <Flex container alignPrimary="space-between" alignSecondary="center">
        ...
        <FlexItem size="major">
          <Flex gap="600" alignPrimary="end" alignSecondary="center">
            <HeaderAuth user={user} login={login} logout={logout} />
          </Flex>
        </FlexItem>
      </Flex>
    </Section>
