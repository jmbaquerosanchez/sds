...
- The path for the new page you are going to create will be `/waiting-list`.
- The design will be located in this figma file: `https://www.figma.com/design/1OQXUrddcTOYCxEPP19ZFr/Simple-Design-System--Community-?node-id=562-9701&m=dev`
...
- The form submit should make a POST request to `/waiting` endpoint with all the form information (The email).
- Client Validation:
...
- The click on the header nav button `Waiting list` should navigate to this page
